...
let products = {
    "searchItems": ['shirts', 'shirts for men', 'shirts for women', 'shirts for men formal', 'shirts blue color', 'iphone 5s', 'iphone 12 case', 'iphone se 2', 'iphone 11 pro', 'jeans', 'T shirts for mens', 'T shirts with cap', 'T shirts full sleeve', 'T shirt with collar', 'T shirt combo']
}
...
let filterList = {
    "BRAND":['Roaster','Puma','Parx','ColourPlus','United Colors of Benetton','Blackberrys','Flying Machine','Louis Philippe Sport','Mast & Harbour'],
    ...
    "DISCOUNT RANGE":['10% and above','20% and above','30% and above','40% and above','50% and above','60% and above']
}